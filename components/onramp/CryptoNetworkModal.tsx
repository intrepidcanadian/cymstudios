        ...
        >
          ...
          <div className="relative z-10 flex flex-col h-full overflow-hidden">
            <div className="relative flex items-center justify-between p-6 border-b border-white/10 dark:border-slate-700/30 backdrop-blur-sm">
              ...
              <button
                onClick={onClose}
                className="p-2 rounded-lg bg-white/10 dark:bg-slate-800/50 hover:bg-white/20 dark:hover:bg-slate-700/50 backdrop-blur-sm border border-white/10 dark:border-slate-700/30 transition-all"
              >
                <X className="w-5 h-5 text-foreground" />
              </button>
            </div>

            <div className="p-6 border-b border-white/10 dark:border-slate-700/30 grid grid-cols-2 gap-4">
              <div className="relative">
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-slate-500 z-10" />
                <input
                  type="text"
                  placeholder="Search cryptocurrencies..."
                  value={searchTerm}
                  onChange={(e) => setSearchTerm(e.target.value)}
                  className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/20 dark:bg-slate-800/30 backdrop-blur-md border border-white/20 dark:border-slate-700/30 text-foreground placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all"
                />
              </div>
              <div className="relative">
                <Search className="absolute left-4 top-1/2 transform -translate-y-1/2 w-5 h-5 text-slate-400 dark:text-slate-500 z-10" />
                <input
                  ...
                  className="w-full pl-12 pr-4 py-3 rounded-xl bg-white/20 dark:bg-slate-800/30 backdrop-blur-md border border-white/20 dark:border-slate-700/30 text-foreground placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/50 focus:border-blue-500/50 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                />
              </div>
            </div>
            ...
            <div className="flex-1 p-6 overflow-hidden flex gap-6 min-h-0">
              <div className="flex-1 overflow-y-auto pr-2">
                <div className="mb-4">
                  ...
                  <p className="text-sm text-slate-600 dark:text-slate-400">Select a cryptocurrency</p>
                </div>
                      ...
                      <div className="relative flex items-center justify-between">
                        <div className="flex items-center gap-4 flex-1">
                          ...
                          <div className="flex-1 min-w-0">
                            ...
                            <div className="text-sm text-slate-600 dark:text-slate-400 truncate">{crypto.name}</div>
              ...
              <div className="w-px bg-white/10 dark:bg-slate-700/30" />
              ...
              <div className="flex-1 overflow-y-auto pl-2">
                {selectedCryptoInternal ? (
                  ...
                  <div className="text-center py-12">
                    <div className="p-4 rounded-xl bg-white/5 dark:bg-slate-800/20 backdrop-blur-sm border border-white/10 dark:border-slate-700/20 inline-block mb-4">
            ...
            {selectedCryptoInternal && selectedNetworkInternal && (
              <div className="relative p-6 pb-6 border-t border-white/10 dark:border-slate-700/30 backdrop-blur-sm bg-white/5 dark:bg-slate-900/20 flex-shrink-0 mt-auto">
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center gap-3">
                    <div className="flex items-center gap-2 px-3 py-1.5 rounded-lg bg-white/10 dark:bg-slate-800/30 backdrop-blur-sm border border-white/20 dark:border-slate-700/30">
